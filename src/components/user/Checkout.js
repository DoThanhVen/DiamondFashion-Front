                    ...
                    <li className="checkout-item">
                      ...
                      <div className="feed-item-list">
                        <div>
                          ...
                          <p className="text-muted text-truncate mb-4">Vui lòng điền đầy đủ tất cả thông tin bên dưới</p>
                          <div className="mb-3">
                            <form>
                              <div>
                                <div className="row">
                                  <div className="col-lg-4">
                                    <div className="mb-3">
                                      <label className="form-label" for="billing-name">Tên</label>
                                      <input type="text" className="form-control" id="billing-name" placeholder="Vui lòng nhập tên" />
                                    </div>
                                  </div>
                                  <div className="col-lg-4">
                                    <div className="mb-3">
                                      <label className="form-label" for="billing-email-address">Địa chỉ email</label>
                                      <input type="email" className="form-control" id="billing-email-address" placeholder="Vui lòng nhập email" />
                                    </div>
                                  </div>
                                  <div className="col-lg-4">
                                    <div className="mb-3">
                                      <label className="form-label" for="billing-phone">Số điện thoại</label>
                                      <input type="text" className="form-control" id="billing-phone" placeholder="Vui lòng nhập số điện thoại" />
                                    </div>
                                  </div>
                                </div>

                                <div className="mb-3">
                                  <label className="form-label" for="billing-address">Địa chỉ</label>
                                  <textarea className="form-control" id="billing-address" rows="3" placeholder="Vui lòng nhập đầy đủ địa chỉ"></textarea>
                                </div>
                    ...
                    <li className="checkout-item">
                      ...
                      <div className="feed-item-list">
                        <div>
                          ...
                          <p className="text-muted text-truncate mb-4">Vui lòng chọn địa chỉ bạn muốn giao hàng đến</p>
                          <div className="mb-3">
                            <div className="row">
                                ...
                                <div>
                                  <label className="card-radio-label mb-0">
                                    ...
                                    <div className="card-radio text-truncate p-3">
                                      <span className="fs-14 mb-4 d-block">Địa chỉ</span>
              ...
              <div className="row my-4">
                ...
                <div className="col">
                  <div className="text-end mt-2 mt-sm-0">
                    ...
                    <i class="fa-solid fa-cart-shopping me-1"></i> Thanh toán </a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card checkout-order-summary">
                <div className="card-body">
                  <div className="p-3 bg-light mb-3">
                    <h5 className="font-size-16 mb-0">Tóm tắt giỏ hàng <span className="float-end ms-2">#MN0124</span></h5>
                  </div>
                  <div className="table-responsive">
                    <table className="table table-centered mb-0 table-nowrap">
                      <thead>
                        <tr>
                          <th className="border-top-0" style={{ width: '110px' }} scope="col">Sản phẩm</th>
                          <th className="border-top-0" scope="col">Mô tả sản phẩm</th>
                          <th className="border-top-0" scope="col">Giá</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          <th scope="row"><img src="images/best-saler-1.jpg" style={{width: '80px', height:'80px'}} alt="product-img" title="product-img" className="avatar-lg rounded" /></th>
                          <td>
                        ...
                        <tr>
                          <td colspan="2">
                            <h5 className="font-size-14 text-start">Giảm giá :</h5>
                          </td>
                          <td>
                            - $ 78
                          </td>
                        ...
                        <tr>
                          <td colspan="2">
                            <h5 className="font-size-14 text-start">Phí vận chuyển :</h5>
                          </td>
                          <td>
                            $ 25
                          </td>
                        ...
                        <tr className="bg-light">
                          <td colspan="2">
                            <h5 className="font-size-14 text-start">Tổng cộng:</h5>
                          </td>
                          <td>
                            $ 745.2
                          </td>
