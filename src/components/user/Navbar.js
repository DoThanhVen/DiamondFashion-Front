          ...
          <div className="row">
            ...
            <div className="col-md-5 my-auto">
              <Nav className="justify-content-end">
                ...
                <NavDropdown title={<span><i className="fa fa-user" style={{color: '#000'}}></i> Tên tài khoản</span>} id="basic-nav-dropdown">
                  <NavDropdown.Item href="/profile"><i className="fa fa-user"></i>Hồ sơ</NavDropdown.Item>
                  <NavDropdown.Item href="/order"><i className="fa fa-list"></i>Đơn hàng của tôi</NavDropdown.Item>
      ...
      <Navbar expand="lg" >
        <div className="container-fluid ">
          ...
          <Navbar.Collapse id="basic-navbar-nav ">
            <Nav className="me-auto  mb-lg-0 container border-bottom">
