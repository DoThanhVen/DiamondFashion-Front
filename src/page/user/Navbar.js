          ...
          <div className="row">
            ...
            <div className="col-md-5 my-auto">
              <Nav className="justify-content-end">
                ...
                <NavDropdown title={<span><i className="fa fa-user" style={{color: '#7fad39'}}></i> Username</span>} id="basic-nav-dropdown">
                  <NavDropdown.Item href="#"><i className="fa fa-user"></i>Hồ sơ</NavDropdown.Item>
                  <NavDropdown.Item href="#"><i className="fa fa-list"></i>Đơn hàng của tôi</NavDropdown.Item>
                  <NavDropdown.Item href="#"><i className="fa fa-heart"></i>Sản phẩm yêu thích</NavDropdown.Item>
                  <NavDropdown.Item href="#"><i className="fa fa-shopping-cart"></i> Giỏ hàng của tôi</NavDropdown.Item>
                  <NavDropdown.Divider />
