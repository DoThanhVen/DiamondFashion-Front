                  ...
                  <div className="col-lg-6">
                    <div className="p-4">
                      ...
                      <form className="row g-3">
                        ...
                        <div className="col-md-6">
                          <label for="inputFullname" className="form-label">Họ tên:</label>
                          <input type="text" className="form-control" id="inputFullname" />
                        </div>
                        <div className="col-md-6">
                          <label for="inputUsername" className="form-label">Số điện thoại:</label>
                          <input type="number" className="form-control" id="inputUsername" />
                        </div>
                        <div className="col-md-6">
                          <label for="inputFullname" className="form-label">Email:</label>
                          <input type="text" className="form-control" id="inputFullname" />
                        </div>
                        <div className="col-12">
                          <label for="inputAddress" className="form-label">Giới tính:</label>
                        ...
                        <div className="col-12">
                          ...
                          <input type="password" className="form-control" id="inputFullname" />
                        </div>
                        <div className="col-12">
                        ...
                        <div className="col-12">
                          <label for="inputAddress2" className="form-label">Hình ảnh:</label>
                          <div className="mb-3">
                            <input className="form-control" type="file" id="formFile" />
                          </div>
                        </div>
                        <div className="col-md-4">
                          <label for="inputCity" className="form-label">Thành phố:</label>
                          <input type="text" className="form-control" id="inputCity" />
                        </div>
                        <div className="col-md-4">
                          <label for="inputCity" className="form-label">Đường:</label>
                          <input type="text" className="form-control" id="inputCity" />
                        </div>
                        <div className="col-md-4">
                          <label for="inputCity" className="form-label">Phường:</label>
                          <input type="text" className="form-control" id="inputCity" />
                        </div>
                        <div className="col-12">
                          <label for="inputCity" className="form-label">Địa chỉ chi tiết (Số nhà):</label>
