            ...
            <div className="col-xs-12 col-sm-12 col-md-9 ">
              <div className="container bg-white p-2 " style={{ borderRadius: '8px' }}>
                <div className="gird-container">
                  ...
                  <div className="gird-item" style={{ backgroundImage: "url('images/bn4.jpg')" }}>
                    <div className="ejercico">
                      <a href="archivos/card.boostrap/index.html">
                        CAJA 3
                      </a>
                    </div>
                  </div>
                  <div className="gird-item" style={{ backgroundImage: "url('images/bn5.jpg')" }}>
                    <div className="ejercico">
                      <a href="archivos/Flex.images/index.html">
                        CAJA 4
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="gird-item tall" style={{ backgroundImage: "url('images/bn2.jpg')" }}>
                    <div className="ejercico">
                      <a href="archivos/form.parpadei/index.html">
                        CAJA 6
                      </a>
                    </div>
                  </div>
                  <div className="gird-item" style={{ backgroundImage: "url('images/bn6.jpg')" }}>
                    <div className="ejercico">
                      <a href="archivos/Flex.images/index.html">
                        CAJA 4
                      </a>
                  ...
                  <div className="gird-item" style={{ backgroundImage: "url('images/bn7.jpg')" }}>
                    <div className="ejercico">
                      <a href="archivos/Flex.images/index.html">
                        CAJA 4
                      </a>
              ...
              <div className="mb-3 bg-white p-4 mb-4" style={{ marginTop: '40px', borderRadius: '8px' }}>
