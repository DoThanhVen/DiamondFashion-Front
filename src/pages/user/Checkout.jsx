                                  ...
                                  <label className="card-radio-label mb-0">
                                    ...
                                    <div className="card-radio text-truncate p-3">
                                      ...
                                      <span className="text-muted fw-normal text-wrap mb-1 d-block">
                                        {addressDefault?.address} , {addressDefault?.ward} , {addressDefault?.district} ,
                                        {addressDefault?.city}
                                      </span>
                      ...
                      {cart.map((item, index) => (
                        <tr>
                          ...
                          <td>
                            ...
                            <p className="text-muted mb-0 mt-1">{item.product.price} x {item.quantity}
                                </p>
                          </td>
