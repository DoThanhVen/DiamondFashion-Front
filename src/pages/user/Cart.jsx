                ...
                <div key={item.product.id} className="card-body">
                  <div className="col-lg-8 mb-4 d-flex">
                    ...
                    <div className="shop-name ms-4 ">
                      <b >Tên shop : {findShopByProduct(item.product.id)}</b> <br/>
                  ...
                  <div className="d-flex align-items-start border-bottom pb-3">
                    <div className="me-4">
                      <img src={`http://localhost:8080/api/uploadImageProduct/${item.product.image_product[0].url}`} style={{ width: '80px', height: '80px' }} alt="" className="avatar-lg rounded" />
                    </div>
                    <div className="flex-grow-1 align-self-center overflow-hidden">
                      <div>
                        <h5 className="text-truncate font-size-18"><a href={"#"} className="text-dark">{item.product.product_name} </a></h5>
                    ...
                    <div className="row">
                      <div className="col-md-4">
                        <div className="mt-3">
                          ...
                          <h5 className="mb-0 mt-2"><span className="text-muted me-2"><del className="font-size-16 fw-normal">$500</del></span>${item.product.price}</h5>
                        </div>
                      </div>
            ...
            <div className="row my-4">
              ...
              <div className="col-sm-6">
                <div className="text-sm-end mt-2 mt-sm-0">
                  ...
                  { cart.length !=0 && <a href="/checkOut" className="btn text-white" style={{ backgroundColor: '#0FA958' }}>
